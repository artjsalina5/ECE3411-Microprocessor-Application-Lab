/* Sets PD1 and PD2 to blink at 2Hz and PC6 and PC7 to blink at 5Hz
 * simultaneously. After every 2 seconds, PD1 and PD2 LEDs and PC6 and PC7 LED
 * interchange frequencies. Knight Rider shifter moves the blinking position on
 * Port D every second, shifting right (default) with wrapping, or left. All
...
int main(void) {
  ...
  uint8_t master_sequence =
      0; // 0=start, 1=PB5, 2=PB5+PB2, 3=PB5+PB2+PB5, 4=complete
